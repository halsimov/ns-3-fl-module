...
#include "power-linear-model.h"

#include "ns3/double.h"
#include "ns3/log.h"
#include "ns3/pointer.h"
#include "ns3/power-linear-model.h"
...
double
PowerLinearModel::GetPower () const
{
  NS_LOG_FUNCTION (this);
  return m_cpupower;
}
...
double
PowerLinearModel::GetFrequency () const
{
  NS_LOG_FUNCTION (this);
  return m_frequency;
}
...
double
PowerLinearModel::GetUtilization () const
{
  NS_LOG_FUNCTION (this);
  return m_util;
}
...
double
PowerLinearModel::GetIdlePowerW () const
{
  NS_LOG_FUNCTION (this);
  return m_idlePowerW;
}
...
int
PowerLinearModel::GetState () const
{
  NS_LOG_FUNCTION (this);
...
double
PowerLinearModel::GetEnergy () const
{
  NS_LOG_FUNCTION (this);
  return m_energy;
}
...
PowerLinearModel::RunApp()
{
  ...
  NS_LOG_DEBUG (
    "PowerLinearModel:Application scheduled successfully!" 
    << " at time = " << Simulator::Now()
  );

  NS_LOG_DEBUG (
    "PowerLinearModel:Application will be terminated in "
    << m_exectime << " seconds "
  );
}
...
PowerLinearModel::TerminateApp()
{
  ...
  NS_LOG_DEBUG (
    "PowerLinearModel:Application terminated successfully!" 
    << " at time = " << Simulator::Now()
  );
}
...
PowerLinearModel::UpdatePower ()
{
  ...
  NS_LOG_DEBUG (
    "PowerLinearModel:Updating power"
    << " at time = " << Simulator::Now()
  );
  ...
  m_powerUpdateEvent = Simulator::Schedule(
    m_powerUpdateInterval, &PowerLinearModel::UpdatePower, this
  );
}

void
PowerLinearModel::DoDispose ()
{
  NS_LOG_FUNCTION (this);
  m_temperatureModel = nullptr;      // TemperatureModel
...
void
PowerLinearModel::SetDeviceType(std::string deviceType)
{
  NS_LOG_FUNCTION (this << deviceType);
  //TODO
}
